...
def getRatings(file_path):
    ...
    rateSer = ratings.groupby(["Book-Rating"])['Book-Rating'].count()
...
if __name__ == "__main__":
    ...
    #getBookMess("../data/bookcrossings/BX-Books.csv")
    getUserMess("../data/bookcrossings/BX-Users.csv")
